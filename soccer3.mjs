...
export default class SOCcer {
    ...
    static version_info = new Map(Object.entries({
        "SOCcerNET 0.0.1": {
            "type": "SOCcerNET",
            "soccer_url": "https://danielruss.github.io/soccerNet/SOCcer_dev3.0.5.onnx",
            "embedding_model_name": 'Xenova/GIST-small-Embedding-v0',
            "pooling": "cls",
            "version": "SOCcerNET 0.0.1",
            "soccerVersion": "dev3.0.5",
        ...
        "SOCcerNET 0.0.2": {
            "type": "SOCcerNET",
            "soccer_url": "https://danielruss.github.io/soccerNet/SOCcer_dev3.0.6.onnx",
            "embedding_model_name": 'Xenova/GIST-small-Embedding-v0',
            "pooling": "cls",
            "version": "SOCcerNET 0.0.2",
            "soccerVersion": "dev3.0.6",
        ...
        "SOCcerNET 0.0.3.Jan27": {
            ...
            "soccerVersion": "dev3.0.7.Jan27",
            "soccerNetVersion": "0.0.3.Jan27",
            "train_data": "Oct2024",
            "coder": SOCcerNET,
            "required_columns": ["JobTitle", "JobTask"],
        },
        "SOCcerNET 0.0.4.Feb27": {
            "type": "SOCcerNET",
            "soccer_url": "https://danielruss.github.io/soccerNet/s3_Feb272025.onnx",
            "embedding_model_name": 'Xenova/GIST-small-Embedding-v0',
            "pooling": "cls",
            "version": "SOCcerNET 0.0.4.Feb27",
            "soccerVersion": "dev3.0.8.Feb27",
            "soccerNetVersion": "0.0.4.Feb27",
            "train_data": "Feb2025",
            "coder": SOCcerNET,
            "required_columns": ["JobTitle", "JobTask"],
        },
        "SOCcerNET 1.0.0": {
            "type": "SOCcerNET",
            "soccer_url": "https://danielruss.github.io/soccerNet/SOCcer_v3.0.0.onnx",
            "embedding_model_name": 'Xenova/GIST-small-Embedding-v0',
            "pooling": "cls",
            "version": "SOCcerNET 1.0.0",
            "soccerVersion": "3.0.0",
            "soccerNetVersion": "1.0.0",
            "train_data": "Feb2025",
            "coder": SOCcerNET,
            "required_columns": ["JobTitle", "JobTask"],
        },
